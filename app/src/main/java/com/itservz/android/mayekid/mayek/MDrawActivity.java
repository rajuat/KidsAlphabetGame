...
//        views.put(imageId, currentDrawView);
//        currentDrawView.setBackgroundResource(imageId);
    ...
    private void getView(int imageId) {
        //play with views
        if(views.containsKey(imageId)){
            System.out.println("view existed " + imageId);
            currentDrawView = views.get(imageId);
        } else {
            //first time looking at a mayek
            System.out.println("new view created " + imageId);
            MayekDrawView newView = (MayekDrawView)findViewById(R.id.drawing1);
            newView.setBackgroundResource(imageId);
            views.put(imageId,newView);
            currentDrawView = views.get(imageId);
        }
        currentDrawView.postInvalidate();

        System.out.println("map value " + views.keySet());
    }
